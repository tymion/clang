...
public:
  ...
  struct ExpressionEvaluationContextRecord {
    ...
    ExpressionEvaluationContextRecord(
        ExpressionEvaluationContext Context, unsigned NumCleanupObjects,
        CleanupInfo ParentCleanup, Decl *ManglingContextDecl,
        ExpressionKind ExprContext, bool IsDecltype, bool IsUnrefltype = false)
...
public:
  ...
  void PushExpressionEvaluationContext(
      ...
      bool IsDecltype = false, bool IsUnrefltype = false);
  ...
  ExprResult ActOnReflexprGSExpr(bool idOnly, SourceLocation opLoc,
                                 SourceRange argRange);
...
public:
  EnterUnrefltypeEvaluationContext(Sema &Actions,
      ...
      : Actions(Actions) {
    Actions.PushExpressionEvaluationContext(
        NewContext, LambdaContextDecl,
        Sema::ExpressionEvaluationContextRecord::EK_Other, false /*IsDecltype*/,
        true);
  }
  EnterUnrefltypeEvaluationContext(Sema &Actions,
                                   Sema::ExpressionEvaluationContext NewContext,
      ...
      : Actions(Actions) {
    Actions.PushExpressionEvaluationContext(
        NewContext, Sema::ReuseLambdaContextDecl,
        Sema::ExpressionEvaluationContextRecord::EK_Other, false /*IsDecltype*/,
        true);
  }
