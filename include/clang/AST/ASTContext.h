...
private:
  ...
  ReflexprExpr *GlobalScopeReflexpr = nullptr;
  ReflexprExpr *NoSpecifierReflexpr = nullptr;
  typedef llvm::DenseMap<unsigned, ReflexprExpr *> SpecifierReflexprMap;
  SpecifierReflexprMap SpecifierReflexprs;
  typedef llvm::DenseMap<const NamedDecl *, ReflexprExpr *>
      NamedDeclReflexprMap;
...
public:
  ...
  /// for destruction.
  template <typename T> void addDestruction(T *Ptr) {
