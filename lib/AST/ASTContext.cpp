...
ASTContext::ASTContext(LangOptions &LOpts, SourceManager &SM,
    ...
    : FunctionProtoTypes(this_()), TemplateSpecializationTypes(this_()),
      ...
      MetaobjectEncodingKey(makeMetaobjectKey()), GlobalScopeReflexpr(nullptr),
      NoSpecifierReflexpr(nullptr), SpecifierReflexprs(10), Int128Decl(nullptr),
...
BuiltinTemplateDecl *ASTContext::getUnpackMetaobjectSeqDecl() const {
  if (!UnpackMetaobjectSeqDecl)
    UnpackMetaobjectSeqDecl = buildBuiltinTemplateDecl(
        BTK__unpack_metaobject_seq, getTypePackElementName());
...
uintptr_t ASTContext::makeMetaobjectKey() const {
  ...
  std::mt19937 re(rd());
  std::independent_bits_engine<std::mt19937, sizeof(uintptr_t) * CHAR_BIT,
                               uintptr_t>
      ibe(re);
...
ReflexprExpr *ASTContext::cacheGlobalScopeReflexpr(ReflexprExpr *E) {
...
ReflexprExpr *ASTContext::cacheSpecifierReflexpr(tok::TokenKind K,
                                                 ReflexprExpr *E) {
...
ReflexprExpr *ASTContext::findSpecifierReflexpr(tok::TokenKind K) const {
...
ReflexprExpr *ASTContext::cacheNamedDeclReflexpr(const NamedDecl *ND,
                                                 ReflexprExpr *E) {
...
ReflexprExpr *ASTContext::findNamedDeclReflexpr(const NamedDecl *ND) const {
...
CanQualType ASTContext::getMetaobjectIdType() const { return MetaobjectIdTy; }
